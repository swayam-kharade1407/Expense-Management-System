...
<body>
                            ...
                            <fieldset>
                                <div class="form-group">
                                    ...
                                    <input class="form-control" placeholder="<?php echo
                                                                                $Emails; ?>" name="email" type="email" autofocus required>
                                </div>
                                <div class="form-group">
    ...
    <div class="cookies_outer" id="cookies_inner">
        <div class="d-flex flex-wrap justify-content-center align-items-center cookies-innerr">
            <p>
                ...
                <a href="#" title="Learn More" class="learn-more"></a>
                <button class="btn accept-cookies-btn btn-primary" id="accept_cookies" title="I Accept">Accept</button>
            </p>
        </div>
    </div>
