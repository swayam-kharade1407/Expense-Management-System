...
if (isset($_FILES['fileup'])) {
	$soure = $_FILES['fileup']['tmp_name'];
	$dest = $_FILES['fileup']['name'];

	$upload = 'upload/';
	$fupload = move_uploaded_file($source, $upload . $dest);
	if ($fupload)
		echo "YES";
	else
		echo "NO";
...
<body>
	...
	<div class="container">
			...
			<div class="col-md-6 col-md-offset-3">
				<div class="login-panel panel panel-primary">
					...
					<div class="panel-body">
						...
						<form method="post" action="identity.php" role="form" enctype="multipart/form-data">
							<fieldset>
		...
		<div class="row text-center">
			<small>copyright © <?php echo Date('Y'); ?> Expense Manager | All right Reserved</small><br>
